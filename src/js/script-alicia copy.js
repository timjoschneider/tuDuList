    ...
    addTask(userInput, listType) {
        ...
        if (userInput.value) {
            switch (listType) {
                case "open":
                    // add a new task
                    this._tasks.push(userInput.value);
                    const listItemOpen = `
                        <li class="shadow-sm li-item pb-2">
                            <span class="checkbox p-2">
                                <input class="form-check-input" type="checkbox" value="">
                            </span>
                            <span class="content p-2">${userInput.value}</span>
                ...
                case "done":
                    ...
                    const listItemDone = `
                        <li class="pb-2 m-0 li-item-done">
                            ...
                            <span class="content">${cutString(userInput.value)}</span>
                        </li>
                        `;
...
liOpen.forEach((li) => {
    ...
    checkbox.addEventListener('change', (event) => {
        ...
        // add to list doneList
        openList.addTask(content, "open");
        // remove from list open
        doneList.deleteTask(content, "done");
...
btnAddTask.addEventListener('click', (event) => {
    learningList.addTask(inputAddTask);
}, false);